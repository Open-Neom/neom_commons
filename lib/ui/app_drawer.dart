                ...
                Padding(
                  ...
                  child: ListView(
                    ...
                    children: <Widget>[
                      ...
                      if(AppConfig.instance.appInUse != AppInUse.c) //TODO Not implemented on "C" app yet
                        drawerRowOption(AppDrawerMenu.requests, const Icon(Icons.email), context),
                      Column(
                        children: [
                          const Divider(),
                          if(_.user.userRole != UserRole.subscriber && AppConfig.instance.appInUse != AppInUse.c)
                      ...
                      if(AppConfig.instance.appInUse != AppInUse.c && (_.userController.subscriptionLevel.value >= SubscriptionLevel.creator.value || _.user.userRole.value > UserRole.subscriber.value)) Column(
                        children: [
            ...
            ListTile(
              ...
              title: Column(
                ...
                children: [
                  Row(
                    children: [
                      Text(TextUtilities.capitalizeFirstLetter(_.appProfile.value.name.length > AppConstants.maxDrawerNameLength
                      ...
                      if(_.user.userRole != UserRole.subscriber) IconButton(
                          ...
                          onPressed: ()=> _.isButtonDisabled.value ? {} : AppAlerts.selectProfileModal(context: context,
                              ...
                              onChangeProfile: _.userController.changeProfile,
                              onCreateProfile: _.userController.createProfile
                          )
                      )
                    ],
                  ),
